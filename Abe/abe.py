...
ABE_URL = 'https://github.com/eddef/bitcoin-abe'
...
DEFAULT_HOMEPAGE = "chain/Freicoin";
DEFAULT_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
<head>
...
class Abe:
    ...
    def handle_chains(abe, page):
        ...
        body += [
            ...
            '<tr class="table-info"><th>Currency</th><th>Code</th><th>Block</th><th>Time</th>',
    ...
    def handle_chain(abe, page):
        ...
        #extra = True
        body += ['<p>', nav, '</p>\n',
                 '<table class="table table-bordered table-striped table-hover"><tr><th class="table-active">Block</th><th>Approx. Time</th>',
    ...
    def _show_block(abe, page, dotdotblock, chain, **kwargs):
        ...
        body += ['<table class="table table-bordered table-striped table-hover"><tr class="table-info"><th>Transaction</th><th>Fee</th>'
    ...
    def show_tx(abe, page, tx):
        ...
        body += ['</p>\n',
                 ...
                 '<tr class="table-info"><th>Index</th><th>Previous output</th><th>Amount</th>',
                 '<th>From address</th>']
        ...
        body += ['</table>\n',
                 ...
                 '<tr class="table-info"><th>Index</th><th>Redeemed at input</th><th>Amount</th>',
    ...
    def q_addr(abe, page, chain):
        ...
        return "\n".join(abe.store.firstbits_to_addresses(fb, chain_id = (chain and chain.id)))
    ...
    def q_circulatingfrc(abe, page, chain):
        ...
        Found_add=["1DCyWRmTXB9goqA4Zb88nU1Q8snA7d7n4x",
        ...
        for j in range (0,319):
            ac= Found_add[j]
            if not util.possible_address(ac):
                return 'ERROR: address invalid'

            vc, hc = util.decode_address(ac)
            foundation_balance += abe.store.get_balance(chain.id, hc)
        #print "foundation_balance", foundation_balance
        
        circulatingfrc=(10**16 - 1) - foundation_balance
        return (format_satoshis(circulatingfrc, chain))
